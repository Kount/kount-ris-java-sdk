...
import com.kount.ris.util.payment.*;
...
public abstract class Request {
    ...
    public Request() {
        ...
        this.params.put("VERS", config.VERS);
     ...
     *
     * @param key   The key for the parm
     * @param value The value for the parm
     * @return this
     */
     ...
     *
     * @param orderNumber Merchant unique order number
     * @return this
     */
     ...
     *
     * @param merchantAcknowledgment Merchant acknowledgment
     * @return this
     */
     ...
     *
     * @param authorizationStatus Auth status by issuer
     * @return this
     */
     ...
     * or unavailable.
     *
     * @param avsZipReply Bankcard AVS zip code reply
     * @return this
     */
     ...
     *
     * @param avsAddressReply Bankcard AVS street addres reply
     * @return this
     */
     ...
     *
     * @param cvvReply Bankcard CVV/CVC/CVV2 reply
     * @return this
     */
     ...
     *
     * @param ptyp See SDK documentation for a list of accepted payment types
     * @param ptok The payment token
     * @return this
     */
     ...
     *
     * @param cof Sets the closeOnFinish flag
     * @return this
     */
     ...
     *
     * @param lbin Long Bank Identification Number
     * @return this
     */
