...
public class Inquiry extends Request {
    ...
    public Inquiry() {
        ...
        this.params.put("MODE", InquiryMode.INITIAL_INQUIRY.toString());
        this.params.put("CURR", "USD");
        this.params.put("SDK_VERSION", "Sdk-Ris-" + config.SDK + "-" + config.SDK_VERSION);
    }

    /**
     * Set cash amount of any feasible goods.
     *
     * @param cash int Cash amount of any feasible goods
     * @return this
     */
     ...
     *
     * @param label The name of the user defined field
     * @param value The value of the user defined field
     * @return this
     */
     ...
     *
     * @param currency Currency code, eg, USD, EUR...
     * @return this
     */
     ...
     *
     * @param total Transaction amount in lowest possible denomination of given currency
     * @return this
     */
     ...
     *
     * @param customerName Name of the client or company
     * @return this
     */
     ...
     *
     * @param billingPhoneNumber Billing phone number
     * @return this
     */
     ...
     *
     * @param shippingPhoneNumber Shipping phone number
     * @return this
     */
     ...
     *
     * @param shippingName Shipping name
     * @return this
     */
     ...
     *
     * @param shippingEmail Shipping email
     * @return this
     */
     ...
     *
     * @param uniqueCustomerId Customer-unique ID or cookie set by merchant.
     * @return this
     */
     ...
     *
     * @param userAgent Useragent string of the client
     * @return this
     */
     ...
     *
     * @param cart Collection of CartItems in the shopping cart
     * @return this
     */
